...
date: "2021-08-31"
author: "MNM"
excerpt: "Using variables, different data types, and strings ... cont."
---
...
<CodeBlock code={`File "main.py", line 5, in <module>
print(number)
NameError: name 'number' is not defined`} language='bash'/>
...
<CodeBlock code={`college = "Whatsamatta U"`}/>
...
<CodeBlock code={`food = input("Enter the restaurant's major food item")`}/>
...
![Superscripting](/images/variables-08-31/rocky-index.jpg)
...
![test image size](/images/variables-08-31/slicing-rails.jpg){:class="img-responsive"}
...
![value dot operator](/images/variables-08-31/dot-operator.jpg)
